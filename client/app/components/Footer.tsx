const Footer = () => {
    return (
      <footer className="w-full bg-black-800 text-gray-600 py-6 my-10 border border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-6 text-sm">
            ...
            <a href="https://github.com/MangGlang" className="hover:text-gray-900 transition-colors">Minh</a>
          </div>
        </div>
      </footer>
    );
